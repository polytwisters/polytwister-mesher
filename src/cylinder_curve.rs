...
use nalgebra as na;
use crate::{config::{CylinderMeshConfig, TorusMeshConfig}, cylinder::Cylinder, mesh::{Mesh, Polyline}, pipe_section::{self, PipeSection}, utils::{bisection_search, linspace, sort2}};
    ...
    pub fn discretize_segment(&self, tmin: f64, tmax: f64, resolution: f64) -> Polyline {
        ...
        let t_values = adaptive_sampling::adaptive_sample(
            ...
            &AdaptiveSamplingConfig {
                ...
                topology: adaptive_sampling::Topology1D::Linear,
            },
        );
        dbg!(&t_values);
